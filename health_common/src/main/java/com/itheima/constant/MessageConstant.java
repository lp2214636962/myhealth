...
public class MessageConstant {
    ...
    public static final String GET_SETMEAL_NUMBER_REPORT_FAIL = "获取套餐占比数据失败";
    public static final String GET_SETMEAL_NUMBER_REPORT_SUCCESS = "获取套餐占比数据成功";
    public static final String GET_BUSINESS_REPORT_SUCCESS = "获取运营统计数据成功";
    public static final String GET_BUSINESS_REPORT_FAIL = "获取运营统计数据失败";
    public static final String GET_SETMEAL_LIST_SUCCESS = "查询套餐列表数据成功";
    public static final String GET_SETMEAL_LIST_FAIL = "查询套餐列表数据失败";
    public static final String ERROR_CHECKGROUP_CHECKITEM = "当前检查组和检查项之间存在关联关系，不能删除";
    public static final String ERROR_CHECKGROUP_TAOCAN = "当前套餐和检查组之间存在关联关系，不能删除";
    public static final String ERROR_PERMISSION_ROLE = "当前权限和 之间存在关联关系，不能删除";
    public static final String ERROR_USER_ROLE = "当前用户和角色之间存在关联关系，不能删除";
}
